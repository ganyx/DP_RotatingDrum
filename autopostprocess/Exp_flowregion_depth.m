...
[strr_depth,strr_depth_normbydp,maxdepth_norm,swfit]=strr_depth_fun(strr_botbound,surface_x_real,surface_y_real,dp,xwsfit,stepsfit);
...
datafilename=[filedir 'C0' num2str(filenum(fi)) '\C0' num2str(filenum(fi)) '_strainrate_depth_2.mat'];
